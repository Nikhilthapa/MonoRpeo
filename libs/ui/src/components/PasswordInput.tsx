    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full rounded-lg border border-white bg-card px-3 py-2 pr-10 text-sm text-white placeholder-gray-500 transition-all duration-200 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary ${error ? "border-red-500" : ""} `}
          {...props}
        />
        <button
          type="button"
